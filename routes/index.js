...
router.get('/api/listen', function(req,res){
  client.stream('statuses/filter',{track: '#emojicon'}, function(stream){
    stream.on('data', function(tweet) { 
      ...
      checkForEmoji(tweet.text, tweet.created_at); //sending emoji and date
    });
...
function checkForEmoji(tweet, tweetDate){ //emoji and date
  var emojis =[], x=0, boo;
...
function checkforEmojiOnServer(e, tweetDate, res){ //emoji and date
...
function updateEmojiCount(id, count, tweetDate, res){ //id, count and date
  var requestedId = id;
